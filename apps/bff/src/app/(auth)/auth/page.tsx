...
import { Button } from '@fitness/ui-components';
      ...
      <div className={styles.card}>
        ...
        <div className={styles.footer}>
          {isLogin ? (
            <>
              还没有账户？
              <button type="button" onClick={() => switchForm(false)} className={styles.link}>
                立即注册
              </button>
            </>
          ) : (
            <>
              已有账户？
              <button type="button" onClick={() => switchForm(true)} className={styles.link}>
                立即登录
              </button>
            </>
          )}
